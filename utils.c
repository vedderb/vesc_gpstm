...
const char* utils_fault_to_string(dcdc_fault_code fault) {
	switch (fault) {
	case FAULT_CODE_NONE: return "FAULT_CODE_NONE"; break;
	case FAULT_CODE_OVERCURRENT: return "FAULT_CODE_OVERCURRENT"; break;
	case FAULT_CODE_OVERTEMP: return "FAULT_CODE_OVERTEMP"; break;
	case FAULT_CODE_BOOTING_FROM_WATCHDOG: return "FAULT_CODE_BOOTING_FROM_WATCHDOG"; break;
