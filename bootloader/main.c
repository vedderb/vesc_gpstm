/*
	...
	This file is part of the VESC DCDC bootloader.

	The VESC DCDC bootloader is free software: you can redistribute it and/or modify
    it under the terms of the GNU General Public License as published by
    the Free Software Foundation, either version 3 of the License, or
    (at your option) any later version.

    The VESC DCDC bootloader is distributed in the hope that it will be useful,
...
#define FLASH_ADDRESS_NEW_APP		0x08010000
#define FLASH_PAGES_MAIN_APP		28
